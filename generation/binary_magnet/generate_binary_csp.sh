#!/bin/bash
#SBATCH --job-name=gen_bin_mag_csp
...
#SBATCH --output=logs/gen_bin_mag_csp_%j.out
#SBATCH --error=logs/gen_bin_mag_csp_%j.err
...
cd $HOME/SOFT/mattergen_test/binary_magnet
...
COMPOSITIONS_FILE="binary_magnet_compositions.json"
OUTPUT_DIR="../results/binary_csp_magnets"
...
echo "=========================================="
echo "Binary Magnet Generation (CSP Mode)"
echo "=========================================="
...
if [ ! -f "$COMPOSITIONS_FILE" ]; then
    ...
    echo ""
    echo "Please run search_binary_magnets.py first to generate compositions"
    exit 1
fi
...
echo ""
echo "=========================================="
echo "Binary magnet generation completed!"
echo "=========================================="
echo ""
