...
def main():
    ...
    parser.add_argument('--baseline', type=str,
                        default='MatterSim-MP/baseline_eval_results.json',
                        help="Baseline eval results JSON")
    parser.add_argument('--finetuned', type=str,
                        default='MatterSim-MP/ft_eval_results.json',
                        help="Fine-tuned eval results JSON")
    parser.add_argument('--output', type=str, default='ft_eval_scatter.pdf',
                        help="Output plot file (default: ft_eval_scatter.pdf)")
